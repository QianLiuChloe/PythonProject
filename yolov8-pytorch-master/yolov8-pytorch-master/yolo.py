...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : r'D:\PythonProject\yolov8-pytorch-master\yolov8-pytorch-master\logs\best_epoch_weights.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        with torch.no_grad():
            ...
            # distance = calculate_distance(top_boxes, top_boxes, baseline, focal_length)#需要添加基线长度和相机的焦距

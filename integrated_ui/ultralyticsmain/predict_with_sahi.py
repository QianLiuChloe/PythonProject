...
class SAHIInference:
    ...
    def parse_opt(self):
        ...
        parser.add_argument("--weights", type=str, default=r"C:\Users\fan\Desktop\yolov11\ultralytics-main\runs\res\weights\best.pt", help="initial weights path")
        parser.add_argument("--source", type=str, default=r"C:\Users\fan\Desktop\yolov11\ultralytics-main\raw.v1i.yolov8\demo", help="video file path")
